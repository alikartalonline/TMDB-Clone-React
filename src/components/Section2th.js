...
function Section2th() {
    ...
    useEffect(() => {
        axios(`https://api.themoviedb.org/3/movie/now_playing?api_key=${process.env.REACT_APP_API_KEY}&language=en-US&page=2`)
        ...
        <div className='row'>
            <div className='d-flex'>
                <div className='col-md-12 col-lg'>
                    <h2 className='titlesection text-dark '>İzlemek Ücretsiz</h2>
                </div>

                <div className='selector2th col-lg-1.5'>
